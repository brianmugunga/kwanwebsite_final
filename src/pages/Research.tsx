...
import { BookOpen, Users, Brain, Scale, Heart, Globe } from 'lucide-react';
      ...
      <section className="py-20 bg-gradient-to-br from-stone-900 to-amber-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-stone-300 max-w-3xl mx-auto leading-relaxed">
            Advancing transformative scholarship that centers justice, equity, and liberation. 
            My research challenges traditional criminological frameworks while building new 
