        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            {featuredPublications.map((pub) => (
              <div key={pub.id} className="bg-stone-50 p-8 rounded-xl shadow-lg">
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                  <div className="lg:col-span-3">
                    ...
                    <h3 className="text-2xl font-bold text-stone-900 mb-3">{pub.title}</h3>
                    ...
                    {pub.publisher && (
                      <div className="text-stone-600 mb-4">
                        <span className="font-medium">{pub.publisher}</span>, {pub.pages} pages
                      </div>
                    )}
                    {pub.organization && (
                      <div className="text-stone-600 mb-4">
                        <span className="font-medium">{pub.organization}</span>, {pub.pages} pages
                      </div>
                    )}
                    <p className="text-stone-600 leading-relaxed">{pub.abstract}</p>
                  </div>
                  <div className="space-y-4">
                    <a
                      href={pub.pdfUrl}
                      className="w-full bg-amber-700 hover:bg-amber-800 text-white py-3 px-4 rounded-lg font-semibold transition-colors duration-200 flex items-center justify-center space-x-2"
                    >
                    ...
                    {pub.doi && (
                      <a
                        ...
                        className="w-full border border-stone-300 hover:border-stone-400 text-stone-700 py-3 px-4 rounded-lg font-semibold transition-colors duration-200 flex items-center justify-center space-x-2"
                      >
              ...
              <div key={pub.id} className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex space-x-2 ml-4">
                    <a
                      href={pub.pdfUrl}
                      className="bg-amber-700 hover:bg-amber-800 text-white p-2 rounded-lg transition-colors duration-200"
                      title="Download PDF"
                    >
                      <Download className="h-4 w-4" />
                    </a>
                    {pub.doi && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="border border-stone-300 hover:border-stone-400 text-stone-700 p-2 rounded-lg transition-colors duration-200"
                        title="View DOI"
                      >
                        <ExternalLink className="h-4 w-4" />
                      </a>
